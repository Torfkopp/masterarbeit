...
A step size of 900 seconds is used, which results in 5,760 steps per episode // 9,600 / 28,800 without cutoff
...
NEAT's threshold is increased to a value of 100,000, whilst the number of generations is set to 15. // 30
