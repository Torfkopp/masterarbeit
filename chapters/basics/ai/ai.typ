...
#figure(
  image(width: 50%, "/images/basics/ai_venn.png"),
  caption: [Venn diagram illustrating the relationship between artificial intelligence, machine learning, and deep learning. #footnote("https://www.researchgate.net/figure/Fig-1-Venn-diagram-showing-relationship-between-Artificial-Intelligence-Machine_fig1_362150447")]
) <ai_venn>
